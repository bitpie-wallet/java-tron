...
public class LiteFnQueryGrpcInterceptorTest {
  ...
  @Test
  public void testGrpcBlockIdBatchThrowStatusRuntimeException() {
    final GrpcAPI.BlockLimit message = GrpcAPI.BlockLimit.newBuilder()
        .setStartNum(0)
        .setEndNum(1)
        .build();
  ...
  @Test
  public void testGrpcBlockIndexBatchThrowStatusRuntimeException() {
    final GrpcAPI.BlockLimit message = GrpcAPI.BlockLimit.newBuilder()
        .setStartNum(0)
        .setEndNum(1)
        .build();
  ...
  @Test
  public void testGrpcBlockIndexSegmentBatchThrowStatusRuntimeException() {
    final GrpcAPI.BlockLimit message = GrpcAPI.BlockLimit.newBuilder()
        .setStartNum(0)
        .setEndNum(1)
        .build();
